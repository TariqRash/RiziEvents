...
RiziEvents is an MVP for event publishing and guest registration, built by a four-member student team. The platform focuses on the core features needed to create, publish, and manage events end to end.
...
- The repository documents the full MVP scope.
